...
Spring profiles, if set, can be used to conditionally include spring configuration, beans, ... at **
runtime**.
...
Example of building/running with H2, embedded tomcat, populate data and use spring integration for
messaging:
